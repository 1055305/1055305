...
save_body_mass_svg<-function(penguins_filtered,filename, size1, size2, scaling){
  size1_inches = size1/2.54
  size2_inches = size2/2.54
    svglite(filename, width   = size1_inches, 
                      height  = size2_inches, 
                      scaling = scaling)
    body_mass_hist <- plot_body_mass(penguins_filtered)
    print(body_mass_hist)
...
save_body_mass_svg(penguins_filtered, "figures/bodymass_hist.svg",size1=20, size2=15, scaling = 1)
```
